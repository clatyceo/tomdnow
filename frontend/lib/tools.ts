...
export const tools: Record<string, ToolConfig> = {
  ...
  image: {
    ...
    faq: [
      { q: "Is this tool free?", a: "Yes, completely free with no sign-up required." },
      { q: "Does it do OCR?", a: "This tool extracts EXIF metadata. For OCR text extraction, use our dedicated Image OCR to Markdown tool." },
  ...
  hwp: {
    ...
    title: "HWP to Markdown — tomdnow",
    h1: "Convert HWP to Markdown",
    displayName: "HWP to Markdown",
    subtitle: "Convert Korean Hangul Word Processor files to clean Markdown.",
    type: "hwp",
    inputMode: "file",
    accept: ".hwp",
    category: "documents",
    ...
    color: "#0054a6",
    seo: {
      description: "Free online HWP to Markdown converter. Upload Korean Hangul documents and get Markdown instantly.",
      keywords: ["hwp to markdown", "hangul to markdown", "convert hwp to md"],
    },
    howTo: [
      { step: "Upload your HWP", desc: "Drag and drop or click to select your Hangul document." },
      { step: "Convert", desc: "Our tool converts the HWP file to clean Markdown automatically." },
      { step: "Download", desc: "Preview the result and download your .md file." },
    ],
    whyConvert: [
    ...
    faq: [
      { q: "Is this tool free?", a: "Yes, completely free with no sign-up required." },
      { q: "What is HWP?", a: "HWP is the native file format of Hangul Word Processor, widely used in South Korea." },
      { q: "Does it preserve formatting?", a: "We preserve text content, headings, and structure. Complex layouts may be simplified." },
      { q: "Is my file stored?", a: "No. Files are processed in memory and deleted immediately." },
    ],
  },
  hwpx: {
    key: "hwpx",
    slug: "hwpx-to-markdown",
    title: "HWPX to Markdown — tomdnow",
    h1: "Convert HWPX to Markdown",
    displayName: "HWPX to Markdown",
    subtitle: "Convert HWPX documents to clean, readable Markdown files.",
    type: "hwpx",
    inputMode: "file",
    accept: ".hwpx",
    category: "documents",
    ...
    color: "#0072c6",
    seo: {
      description: "Free online HWPX to Markdown converter. Upload HWPX documents and get Markdown instantly.",
      keywords: ["hwpx to markdown", "hangul to markdown", "convert hwpx to md"],
    },
    howTo: [
      { step: "Upload your HWPX", desc: "Drag and drop or click to select your HWPX document." },
      { step: "Convert", desc: "Our tool converts the HWPX file to Markdown automatically." },
      { step: "Download", desc: "Preview the result and download your .md file." },
    ],
    whyConvert: [
      "Convert modern Hangul documents to Markdown",
      "Migrate HWPX content to cross-platform formats",
      "Feed Korean documents into AI tools for processing",
      "Version control Korean documents with Git",
    ],
    faq: [
      { q: "Is this tool free?", a: "Yes, completely free with no sign-up required." },
      { q: "What is HWPX?", a: "HWPX is the modern XML-based format of Hangul Word Processor, the standard in South Korea." },
      { q: "What's the difference between HWP and HWPX?", a: "HWPX is the newer XML-based format (like DOCX vs DOC). We support both." },
      { q: "Is my file stored?", a: "No. Files are processed in memory and deleted immediately." },
    ],
  },
  ocr: {
    key: "ocr",
    slug: "image-ocr-to-markdown",
    title: "Image OCR to Markdown — tomdnow",
    h1: "Extract Text from Images (OCR)",
    displayName: "Image OCR to Markdown",
    subtitle: "Use AI-powered OCR to extract text from images and convert to Markdown.",
    type: "ocr",
    inputMode: "file",
    ...
    color: "#8b5cf6",
    seo: {
      description: "Free online OCR tool. Extract text from images and scanned documents, output as clean Markdown.",
      keywords: ["ocr to markdown", "image text extraction", "ocr converter", "image to text"],
    },
    howTo: [
      { step: "Upload your image", desc: "Drag and drop or click to select a JPG, PNG, or other image file." },
      { step: "Select language", desc: "Choose the language of the text in your image for better accuracy." },
      { step: "Download", desc: "Preview the extracted text and download your .md file." },
    ],
    whyConvert: [
      "Extract text from scanned documents and photos",
      "Digitize printed text into editable Markdown",
      "Feed image text into AI tools for analysis",
      "Archive scanned documents as searchable text",
    ],
    faq: [
      { q: "Is this tool free?", a: "Yes, completely free with no sign-up required." },
      { q: "What languages are supported?", a: "English, Korean, Japanese, Chinese, German, French, Spanish, and Portuguese." },
      { q: "How is this different from Image to Markdown?", a: "Image to Markdown extracts EXIF metadata. OCR extracts the actual text content from the image." },
      { q: "Is my file stored?", a: "No. Files are processed in memory and deleted immediately." },
    ],
  },
  zip: {
  ...
  txt: {
    ...
    title: "TXT to Markdown — tomdnow",
    h1: "Convert TXT to Markdown",
    displayName: "TXT to Markdown",
    subtitle: "Convert plain text files into formatted Markdown.",
    type: "txt",
    inputMode: "file",
    accept: ".txt",
    category: "data",
    ...
    color: "#6b7280",
    seo: {
      description: "Free online TXT to Markdown converter. Upload plain text files and get formatted Markdown instantly.",
      keywords: ["txt to markdown", "text to markdown", "convert txt to md"],
    },
    howTo: [
      { step: "Upload your TXT", desc: "Drag and drop or click to select your plain text file." },
      { step: "Convert", desc: "Our tool wraps the text content into clean Markdown format." },
      { step: "Download", desc: "Preview the result and download your .md file." },
    ],
    whyConvert: [
      "Add Markdown formatting to plain text notes",
      "Prepare text files for documentation systems",
      "Feed plain text into AI tools with Markdown structure",
      "Use text content in GitHub, Notion, or Obsidian",
    ],
    faq: [
      { q: "Is this tool free?", a: "Yes, completely free with no sign-up required." },
      { q: "What encoding is supported?", a: "UTF-8 encoded text files are fully supported." },
      { q: "Is my file stored?", a: "No. Files are processed in memory and deleted immediately." },
    ],
  },
  rtf: {
    ...
    title: "RTF to Markdown — tomdnow",
    h1: "Convert RTF to Markdown",
    displayName: "RTF to Markdown",
    subtitle: "Convert Rich Text Format files into clean Markdown.",
    type: "rtf",
    inputMode: "file",
    accept: ".rtf",
    category: "documents",
    ...
    color: "#4b5563",
    seo: {
      description: "Free online RTF to Markdown converter. Upload Rich Text files and get clean Markdown instantly.",
      keywords: ["rtf to markdown", "rich text to markdown", "convert rtf to md"],
    },
    howTo: [
      { step: "Upload your RTF", desc: "Drag and drop or click to select your Rich Text file." },
      { step: "Convert", desc: "Our tool strips RTF formatting and outputs clean Markdown." },
      { step: "Download", desc: "Preview the result and download your .md file." },
    ],
    whyConvert: [
      "Convert legacy Rich Text documents to modern Markdown",
      "Migrate RTF content to GitHub, Notion, or Obsidian",
      "Feed RTF document text into AI tools for analysis",
      "Archive Rich Text files as searchable plain text",
    ],
    faq: [
      { q: "Is this tool free?", a: "Yes, completely free with no sign-up required." },
      { q: "Does it preserve formatting?", a: "Text content, bold, and italic are preserved. Complex RTF layouts are simplified for readability." },
      { q: "What is RTF?", a: "RTF (Rich Text Format) is a document format developed by Microsoft, supported by most word processors." },
      { q: "Is my file stored?", a: "No. Files are processed in memory and deleted immediately." },
    ],
  },
};
