...
function SeoContent() {
  return (
    <div className="max-w-3xl mx-auto px-4 pb-20 space-y-12">
      <section>
        <h2 className="text-2xl font-bold text-gray-900">How to Convert Word to Markdown</h2>
      ...
      <section>
        <h2 className="text-2xl font-bold text-gray-900">Why Convert Word to Markdown?</h2>
